...
copy_setup_file()
{
  file="modelsim.ini"
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/araujoj/Downloads/vespa25_11/project_micro_19-11_syntWorking/project_micro_13-11_loops/project_micro/project_micro.cache/compile_simlib/modelsim"
  fi
