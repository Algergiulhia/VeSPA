...
#
# Script generated by Vivado on Sat Nov 25 17:25:20 WET 2023
# SW Build 4029153 on Fri Oct 13 20:13:54 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : RegFileIP.sh
...
#
# Usage        : RegFileIP.sh
#                RegFileIP.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                RegFileIP.sh [-reset_run]
#                RegFileIP.sh [-reset_log]
#                RegFileIP.sh [-help]
#
...
#                script (type 'RegFileIP.sh -help' for more information).
#
...
# script info
echo -e "RegFileIP.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./RegFileIP.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.RegFileIP xil_defaultlib.glbl -o RegFileIP_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./RegFileIP_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/araujoj/Downloads/vespa25_11/project_micro_19-11_syntWorking/project_micro_13-11_loops/project_micro/project_micro.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key RegFileIP_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc RegFileIP_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./RegFileIP.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: RegFileIP.sh [-help]\n\
Usage: RegFileIP.sh [-step]\n\
Usage: RegFileIP.sh [-lib_map_path]\n\
Usage: RegFileIP.sh [-reset_run]\n\
Usage: RegFileIP.sh [-reset_log]\n\
Usage: RegFileIP.sh [-keep_index]\n\
Usage: RegFileIP.sh [-noclean_files]\n\n\
