...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L blk_mem_gen_v8_4_7 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot RegFileIP xil_defaultlib.RegFileIP xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim RegFileIP -key {Behavioral:sim_1:Functional:RegFileIP} -tclbatch cmd.tcl -protoinst "protoinst_files/RegFileIP.protoinst" -protoinst "protoinst_files/memory_ip.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb RegFileIP.wdb xsim.dir libdpi.so)
