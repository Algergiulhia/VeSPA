...
#                script (type 'memory_ip.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.memory_ip xil_defaultlib.glbl -o memory_ip_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./memory_ip_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/tiago/Documents/Vespa/project_micro/project_micro.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key memory_ip_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc memory_ip_simv.daidir vcs_lib c.obj)
