...
#
# Script generated by Vivado on Tue Jan 09 01:06:36 WET 2024
# SW Build 4029153 on Fri Oct 13 20:13:54 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : memory_ip.sh
...
#
# Usage        : memory_ip.sh
#                memory_ip.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                memory_ip.sh [-reset_run]
#                memory_ip.sh [-reset_log]
#                memory_ip.sh [-help]
#
...
# script info
echo -e "memory_ip.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./memory_ip.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L blk_mem_gen_v8_4_7 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot memory_ip xil_defaultlib.memory_ip xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim memory_ip -key {Behavioral:sim_1:Functional:memory_ip} -tclbatch cmd.tcl -protoinst "protoinst_files/memory_ip.protoinst" -protoinst "protoinst_files/RegFileIP.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb memory_ip.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./memory_ip.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: memory_ip.sh [-help]\n\
Usage: memory_ip.sh [-step]\n\
Usage: memory_ip.sh [-lib_map_path]\n\
Usage: memory_ip.sh [-reset_run]\n\
Usage: memory_ip.sh [-reset_log]\n\
Usage: memory_ip.sh [-keep_index]\n\
Usage: memory_ip.sh [-noclean_files]\n\n\
